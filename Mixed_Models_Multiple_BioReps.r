...
# Data
input_file  <- "/Users/allisonpickle/Desktop/Microglia_Morphology_Perimeter_RMixedFormated.csv"
...
# Option 1: nested in Biological_Rep (commented out)
# RawFit <- lmerTest::lmer(Results ~ Treatment + (1 | Biological_Rep/Well),
#                          data = process_data)

# Option 2: random intercept per Treatment:Well combination
